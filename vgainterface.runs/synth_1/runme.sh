...
HD_PWD='C:/GitHub/EmbeddedVGA_Zynq/vgainterface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vgaSystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vgaSystem_wrapper.tcl
